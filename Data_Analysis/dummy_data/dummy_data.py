...
category1_female = [11, 12, 13, 14, 21]
category1_male = [1, 2, 3, 4, 21]
category2_female = [31, 32, 33, 34, 35, 51, 52, 61, 62, 63, 71, 73, 81, 82, 83, 91, 93, 101, 102, 103, 104, 105, 111, 112, 113, 114, 115, 116, 121, 123, 131, 133, 141, 151, 152, 153, 161, 163, 164, 165, 171]
category2_male = [41, 42, 43, 44, 45, 51, 52, 61, 62, 63, 72, 73, 92, 93, 101, 102, 103, 104, 105, 111, 112, 113, 114, 115, 116, 122, 123, 132, 133, 142, 151, 152, 153, 162, 163, 164, 165, 171]
...
category8_all = [781, 782, 783, 791, 792, 793, 794, 795, 796, 801, 802, 803]
category8_kids = [811, 812, 813, 821, 822, 823, 831, 832, 833, 834, 835, 841, 842, 843, 851, 852, 853, 854, 855, 856]
...
category_users = {
    'category_1_female': {
        'user_id': list(range(91001,91011)),
        'gender': 'C',
        'age': 100,
        'category': category1_female
    },
    'category_1_male': {
        'user_id': list(range(91011,91021)),
        'gender': 'C',
        'age': 100,
        'category': category1_male
    },
    'category_2_female': {
        'user_id': list(range(91021,91031)),
        'gender': 'C',
        'age': 100,
        'category': category2_female
    },
    'category_2_male': {
        'user_id': list(range(91031,91041)),
        'gender': 'C',
        'age': 100,
        'category': category2_male
    },
    'category_3': {
    ...
    'category_8': {
        'user_id': list(range(91141,91151)),
        'gender': 'C',
        'age': 100,
        'category': category8_all
    },
    'category_8_kids': {
        'user_id': list(range(91151,91161)),
        'gender': 'C',
        'age': 100,
        'category': category8_kids
    },
    'category_9': {
...
for category_group in category_users.keys():
    for user in category_users[category_group]['user_id']:
        for category in category_users[category_group]['category']:
            raw_dummy_data.append([user, category, 1])
